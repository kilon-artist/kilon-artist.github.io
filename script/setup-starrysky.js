...
const starTypes = [
    ...
    { name: 'mercury', prob: 0.007, size: [0.7, 0.7], speed: [0.12, 0.12], blinkSpeed: [0.04, 0.04], color: 'rgb(98, 200, 80)', maxOpacity: [0.9, 0.9], minOpacity: [0.3, 0.3] },
    ...
    { name: 'mars', prob: 0.005, size: [1, 1], speed: [0.06, 0.06], blinkSpeed: [0.02, 0.02], color: 'rgb(255, 51, 51)', maxOpacity: [0.7, 0.7], minOpacity: [0.2, 0.2] },
